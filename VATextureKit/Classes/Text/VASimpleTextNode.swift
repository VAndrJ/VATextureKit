//
//  VASimpleTextNode.swift
//  Pods
//
//  Created by VAndrJ on 9/19/24.
//
...
open class VASimpleTextNode: ASTextNode2, @unchecked Sendable {
...
#else
open class VASimpleTextNode: ASTextNode, @unchecked Sendable {
