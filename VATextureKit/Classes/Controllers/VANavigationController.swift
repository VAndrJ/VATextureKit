...
open class VANavigationController: ASDKNavigationController {
    ...
    private func superPushViewController(_ viewController: UIViewController, animated: Bool) {
...
class VATransitionAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let overlayView = transitionContext.containerView
